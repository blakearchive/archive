...
class BlakePreviewImporter(BlakeImporter):
  ...
  def process_preview_file(self,preview):
      ...
      root2 = self.get_document_tree(preview)
      p.source = self.get_source_for_preview(root2)
...
class BlakeDocumentImporter(BlakeImporter):
    ...
    def process_virtual_work(self, entry, work):
        ...
        for obj in objects:
            ...
            obj.full_object_id = re.sub(r"\s*[Oo]bject 1\s*", "Object "+str(obj.object_number)+" ", obj.full_object_id)
