...
class BlakeCopyImporter(BlakeImporter):
    ...
    def process(self, document):
        ...
        copy.comp_date_string = self.get_compdate_string(root)
        copy.comp_date_value = self.get_compdate_value(root)
        copy.comp_date = self.extract_date(copy.comp_date_string)
