angular.module("blake").controller("CompareController", function ($scope,$routeParams,$rootScope,$window,$modal,$cookies,BlakeDataService,imageManipulation,CompareObjectsFactory) {
    let vm = this;
    ...
    vm.toggleTools = function(){
        ...
        $scope.$broadcast('compareCtrl::toggleTools',vm.showTools);
    };
