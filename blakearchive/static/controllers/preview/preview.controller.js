        ...
        vm.bds.setSelectedCopy(vm.bds.workCopies[0].bad_id).then(function(result) {
            ...
            if(vm.bds.copyObjects[0].dbi == 'but770.1.1.pt') {
                ...
                for (var i = 1; i < 9; i++) {
                    ...
                    switch(i) {
                        case 1:
                            vm.options1.tileSources.url = url;
                            vm.options1.tileSources.x = 1;
                            vm.options1.tileSources.y = 0;
                            break;
                        case 2:
                            vm.options2.tileSources.url = url;
                            vm.options2.tileSources.x = 0;
                            vm.options2.tileSources.y = 0;
                            break;
                        case 3:
                            vm.options3.tileSources.url = url;
                            break;
                        case 4:
                            vm.options4.tileSources.url = url;
                            break;
                        case 5:
                            vm.options5.tileSources.url = url;
                            break;
                        case 6:
                            vm.options6.tileSources.url = url;
                            break;
                        case 7:
                            vm.options7.tileSources.url = url;
                            break;
                        case 8:
                            vm.options8.tileSources.url = url;
                            break;
                    }
                }
