        ...
        try:
            if blake_object.supplemental is None:
                obj = {
                    ...
                    "illustration_description": json.dumps(blake_object.illustration_description if blake_object.illustration_description is not None + ' ' + ' '.join([c['#text'] for c in blake_object.components if c is not None] )),
